...
export const createRoute = () => {
  ...
  // Quote interactions
    router.get('/fillQuote/:userId', (req: Request, res: Response) => {
    fillQuote(req, res); // Handle retrieving pre-fill quote info
  });

  router.post('/addQuote/:userId', (req: Request, res: Response) => {
    addQuote(req, res); // Handle creating new fuel quotes
  });

  router.get('/viewQuotes/:userId', (req: Request, res: Response) => {
